...
def predict_next_stage(trainer, stage_to_be_predicted_folder):
    ...
    for pat in trainer.dataset_val.keys():
        ...
        data_preprocessed = np.load(data_file)['dataloader'][:-1]
        ...
        data_nextstage = np.load(data_file_nextstage)['dataloader']
...
if __name__ == "__main__":
    ...
    and not on the dataloader the network was trained on. Run it with
