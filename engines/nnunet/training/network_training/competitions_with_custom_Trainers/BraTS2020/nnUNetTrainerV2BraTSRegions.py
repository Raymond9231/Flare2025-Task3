...
from training.nnunet.training.loss_functions.dice_loss import DC_and_BCE_loss, get_tp_fp_fn_tn, SoftDiceLoss
...
class nnUNetTrainerV2BraTSRegions(nnUNetTrainerV2):
    ...
    def initialize(self, training=True, force_load_plans=False):
        """
        this is a copy of nnUNetTrainerV2's initialize. We only add the regions to the dataloader augmentation
        :param training:
