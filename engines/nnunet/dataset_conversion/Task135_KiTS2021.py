...
if __name__ == '__main__':
    # this is the dataloader folder from the kits21 github repository, see https://github.com/neheller/kits21
    kits_data_dir = '/home/fabian/git_repos/kits21/kits21/dataloader'
