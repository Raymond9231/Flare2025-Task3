...
if __name__ == '__main__':
    ...
    Working with 2D dataloader in nnU-Net requires a small workaround in the creation of the dataset. Essentially, all images
    ...
    base = '/media/fabian/dataloader/road_segmentation_ideal'
