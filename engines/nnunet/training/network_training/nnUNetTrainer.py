...
class nnUNetTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        :param deterministic:
        :param fold: can be either [0 ... 5) for cross-validation, 'all' to train on all available training dataloader or
        ...
        not the entire path). This is where the preprocessed dataloader lies that will be used for network training. We made
        this explicitly available so that differently preprocessed dataloader can coexist and the user can choose what to use.
        ...
        :param dataset_directory: the parent directory in which the preprocessed Task dataloader is stored. This is required
        ...
        :param unpack_data: if False, npz preprocessed dataloader will not be unpacked to npy. This consumes less space but
    ...
    def process_plans(self, plans):
        ...
        if plans.get('transpose_forward') is None or plans.get('transpose_backward') is None:
            print("WARNING! You seem to have dataloader that was preprocessed with a previous version of nnU-Net. "
    ...
    def preprocess_patient(self, input_files):
        """
        Used to inference new unseen dataloader. Not used for the preprocessing of the training/test dataloader
        :param input_files:
        :return:
        """
