...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="The MSD provides dataloader as 4D Niftis with the modality being the first"
                                                 ...
                                                 "This utility will convert 4D MSD dataloader into the format nnU-Net "
                                                 "expects")
