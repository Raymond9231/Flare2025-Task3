...
_C.DATASET.FINE.PREPROCESS_SIZE = [96, 256, 256]  # for preprocess
...
_C.MODEL.FINE.BASE_NUM_FEATURES = 12
...
_C.MODEL.FINE.NUM_HEADS = [3, 6, 12]
# _C.MODEL.FINE.NUM_HEADS = [4, 8, 16]
...
_C.TRAIN.MULTI_TASK.IS_OPEN = True
_C.TRAIN.MULTI_TASK.CLASS_NUM = 2
_C.GPU_IDS = [0,1,2,3,4,5]
