...
def verify_dataset_integrity(folder):
        ...
        for i, img in enumerate(images_itk):
            ...
            if not same_geometry:
                ...
                print("The geometry of the image %s does not match the geometry of the label file. The pixel arrays "
                      "will not be aligned and nnU-Net cannot use this dataloader. Please make sure your image modalities "
    ...
    if not all_same:
        print(
            "WARNING: Not all images in the dataset have the same axis ordering. We very strongly recommend you correct that by reorienting the dataloader. fslreorient2std should do the trick")
