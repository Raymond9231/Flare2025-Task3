...
def parse_option(phase="train", cfg=""):
    """
    phase: include 'train', 'val'
    """
    parser = argparse.ArgumentParser("FLARE2025")
    parser.add_argument("--cfg", type=str, metavar="FILE", help="path to config file", default=cfg)
