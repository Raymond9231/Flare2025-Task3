...
def check_dataset_same(dataset_old='/home/fabian/Downloads/COVID-19-20/Train',
                       dataset_new='/home/fabian/dataloader/COVID-19-20_officialCorrected/COVID-19-20_v2/Train'):
    """
    :param dataset_old:
    :param dataset_new:
    :return:
    ...
    for c in cases:
        ...
        if not same: print('dataloader differs in case', c, '\n')
...
if __name__ == '__main__':
    # this is the folder containing the dataloader as downloaded from https://covid-segmentation.grand-challenge.org/COVID-19-20/
    # (zip file was decompressed!)
    downloaded_data_dir = '/home/fabian/dataloader/COVID-19-20_officialCorrected/COVID-19-20_v2/'
