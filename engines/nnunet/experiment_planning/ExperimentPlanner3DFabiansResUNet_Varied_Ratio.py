...
class ExperimentPlanner3DFabiansResUNet_Varied_Ratio(ExperimentPlanner3D_v21):
    ...
    def get_target_size(self):
        """
        per default we use the 50th percentile=median for the target spacing. Higher spacing results in smaller dataloader
        and thus faster and easier training. Smaller spacing results in larger dataloader and thus longer and harder training
    ...
    def plan_experiment(self):
        ...
        if more:
            ...
            # median shape of the lowest stage must be 4 times as much as the network can preprocess at once (128x128x128 by
        ...
        # removed training dataloader based postprocessing. This is deprecated
