...
class ExperimentPlanner3D_v21_customTargetSpacing_2x2x2(ExperimentPlanner3D_v21):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        # we change the dataloader identifier and plans_fname. This will make this experiment planner save the preprocessed
        # dataloader in a different folder so that they can co-exist with the default (ExperimentPlanner3D_v21). We also
        # create a preprocess plans file that will be linked to this dataloader
